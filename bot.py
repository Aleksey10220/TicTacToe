...
BOT_TOEKN = '5978710739:AAFJh5-lPOhTC5cu9IHg6zuT1vxP437EOH8'
...
async def set_bot_comands(dp: Dispatcher):
   await dp.bot.set_my_commands([
        types.BotCommand("start" , "Запустить этого бота"),
        types.BotCommand("game" ,  "Сыграть в игру с ботом")
   ])
...
if __name__ == '__main__':
    executor.start_polling(dp , on_startup=set_bot_comands)